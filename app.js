(function () {
  ...
  var REGIONS = [
    ...
    { id: "gangwon", name: "강원" },
    { id: "chungnam-chungbuk", name: "충남·충북" },
    { id: "daejeon", name: "대전" },
    { id: "gyeongbuk", name: "경북" },
    { id: "daegu", name: "대구" },
    { id: "gwangju", name: "광주" },
    { id: "jeonnam-jeonbuk", name: "전남·전북" },
    { id: "busan-gyeongnam", name: "부산·경남" },
    { id: "ulsan", name: "울산" },
    { id: "jeju", name: "제주" }
  ];
  ...
  var BRANCHES = [
    ...
    { id: "cheonan", name: "천안지점", region: "chungnam-chungbuk", type: "general", waitingTeams: 2, avgServiceMin: 10 },
    { id: "cheongju", name: "청주지점", region: "chungnam-chungbuk", type: "general", waitingTeams: 2, avgServiceMin: 10 },
    { id: "daejeon-branch", name: "대전지점", region: "daejeon", type: "general", waitingTeams: 3, avgServiceMin: 11 },
    { id: "pohang-wm", name: "포항WM", region: "gyeongbuk", type: "general", waitingTeams: 2, avgServiceMin: 12 },
    { id: "daegu-wm", name: "대구WM", region: "daegu", type: "general", waitingTeams: 4, avgServiceMin: 13 },
    { id: "gwangju-branch", name: "광주지점", region: "gwangju", type: "general", waitingTeams: 3, avgServiceMin: 11 },
    { id: "jeonju", name: "전주지점", region: "jeonnam-jeonbuk", type: "general", waitingTeams: 2, avgServiceMin: 10 },
    { id: "busan-wm", name: "부산WM", region: "busan-gyeongnam", type: "general", waitingTeams: 6, avgServiceMin: 11 },
    { id: "haeundae-centum-wm", name: "해운대센텀WM", region: "busan-gyeongnam", type: "general", waitingTeams: 4, avgServiceMin: 13 },
    { id: "changwon", name: "창원지점", region: "busan-gyeongnam", type: "general", waitingTeams: 3, avgServiceMin: 10 },
